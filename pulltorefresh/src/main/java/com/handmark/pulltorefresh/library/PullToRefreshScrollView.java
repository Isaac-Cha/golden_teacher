...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
	...
	public void setScrollViewListener(PullToRefreshScrollView scrollView,ScrollViewListener scrollViewListener) {

		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			((InternalScrollViewSDK9)scrollView.getRefreshableView()).setScrollViewListener(scrollViewListener);
		} else {
			((MyScrollview)scrollView.getRefreshableView()).setScrollViewListener(scrollViewListener);
		}
	...
	protected ScrollView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			internalScrollViewSDK9 = new InternalScrollViewSDK9(context, attrs);
