...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private OnScrollEventListener<T> mOnScrollEventListener;
	...
	@Override
	public void setOnScrollEventListener(OnScrollEventListener<T> listener) {
	...
	public static interface OnScrollEventListener<V extends View> {
		 ...
		 */
		public void onPullEvent(int scrollY);
